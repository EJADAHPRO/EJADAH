          ...
          <div style={{ width: 280, flexShrink: 0 }}>
            <div style={{ position: "sticky", top: 88, display: "flex", flexDirection: "column" as const, gap: 16 }}>
              ...
              <div style={{ background: `rgba(255,107,26,0.06)`, border: `1px solid rgba(255,107,26,0.2)`, borderRadius: 16, padding: "18px 16px" }}>
                ...
                <div style={{ fontFamily: "Inter", fontSize: 12, color: brand.warmGray, marginBottom: 12, lineHeight: 1.5 }}>Call our private training team — we'll help scope your program before you fill the form.</div>
                <div style={{ fontFamily: "Inter", fontWeight: 700, fontSize: 14, color: brand.orange }}>+20 100 EJADAH</div>
                <div style={{ fontFamily: "Inter", fontSize: 12, color: brand.warmGray, marginTop: 4 }}>training@ejadah.com</div>
              </div>
            </div>
          </div>
        </div>
